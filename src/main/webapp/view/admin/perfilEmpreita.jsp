...
<head>
    <meta charset="UTF-8">
    <title>Agro - Perfil Empreita</title>
...
<div class="container-fluid content mt-2">
    ...
    <div class="card shadow-sm mb-3 d-none" id="headerFuncionario">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                <div>
                    <h4 class="mb-1"><i class="fas fa-hard-hat me-2 text-warning"></i><span id="nomeFunc"></span></h4>
            ...
            <div class="row g-2 mt-2">
                <div class="col-auto">
                    <span class="text-muted small"><i class="fas fa-file-signature me-1 text-success"></i>
                    Valor acordado (ref.): <strong id="infoValorAcordado" class="text-success"></strong></span>
                </div>
                <div class="col-auto">
        ...
        <div class="col-6 col-md-3">
            <div class="card shadow-sm border-0 bg-success text-white">
                <div class="card-body text-center py-3">
                    <div class="fs-3 fw-bold" id="cardQtd">-</div>
                    <div class="small">Empreitas</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
    ...
    <div class="row g-3">
        <!-- LANÇAMENTOS DE EMPREITA -->
        <div class="col-lg-7">
            <div class="card shadow-sm mb-3">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h6 class="text-success fw-bold mb-0">
                        <i class="fas fa-list-check me-2"></i>Empreitas (dia e valor)
                    </h6>
                    <button class="btn btn-success btn-sm" id="btnNovaEmpreita" data-bs-toggle="modal" data-bs-target="#modalEmpreita">
                        <i class="fas fa-plus me-1"></i>Nova Empreita
                    </button>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover mb-0">
                            <thead class="table-light">
                                <tr><th>Data</th><th>Descrição</th><th class="text-end">Valor</th><th class="text-end">Ações</th></tr>
                            </thead>
                            <tbody id="bodyEmpreita">
                                <tr><td colspan="4" class="text-center text-muted py-3">Selecione um período.</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body" id="painelFechamentoEmpreita">
...
<!-- Modal: Nova/Editar Empreita -->
<div class="modal fade" id="modalEmpreita" tabindex="-1">
    <div class="modal-dialog"><div class="modal-content">
        <div class="modal-header bg-success text-white">
            <h5 class="modal-title" id="modalEmpreitaTitulo"><i class="fas fa-list-check me-2"></i>Nova Empreita</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
            <div id="alertaEmpreita" class="alert d-none"></div>
            <div class="mb-2">
                <label class="form-label">Data *</label>
                <input type="date" class="form-control" id="empreitaData">
            </div>
            <div class="mb-2">
                <label class="form-label">Descrição do serviço</label>
                <input type="text" class="form-control" id="empreitaDescricao" maxlength="200">
            </div>
            <div class="mb-2">
                <label class="form-label">Valor (R$) *</label>
                <div class="input-group">
                    <span class="input-group-text">R$</span>
                    <input type="text" class="form-control" id="empreitaValor" placeholder="0,00">
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <button class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
            <button class="btn btn-success" id="btnSalvarEmpreita"><i class="fas fa-save me-1"></i>Salvar</button>
        </div>
    </div></div>
</div>
    ...
    <div class="modal-dialog"><div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-2"><label class="form-label">Data *</label>
                <input type="date" class="form-control" id="valeData"></div>
            <div class="mb-2"><label class="form-label">Valor (R$) *</label>
                <input type="number" class="form-control" id="valeValor" min="0.01" step="0.01" placeholder="0,00"></div>
            ...
            <div class="mb-2"><label class="form-label">Descrição</label>
                <input type="text" class="form-control" id="valeDescricao" maxlength="200"></div>
        </div>
        <div class="modal-footer">
            <button class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
